...
function getOrderInfo(payMode, payType, payAmount){
    // 此处填写商户的 uid
    // 必填
    var payMerchId = '5131668359943419';     

    // 此处填写商户的 token
    // 必填
    var payMerchToken = 'pghlz5xz05wkgw2z1f6p312nz05dibbx'; 
    ...
    // 支付成功后异步通知地址，必须是公网地址
    // 必填
    var payNotifyUrl = "http://localhost:8080/payment/standard";

    // 支付成功后同步跳转地址，必须是公网地址
    // 该参数仅标准模式需要指定。
    var payReturnUrl = '';
    if(payMode == '1'){
        payReturnUrl = "http://localhost:8080/payment/standard";
    }
